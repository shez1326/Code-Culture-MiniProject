...
public class Frame extends JFrame {
    ...
    private void swapToServicesActionPerformed(ActionEvent e) {
        ...
        try {
            String titleChoosen = title.getSelectedItem().toString();
            String fName = firstName.getText();
            String sName = surname.getText();
            String addressInputted = address.getText();
            int dayChoosen = Integer.valueOf(day.getSelectedItem().toString());
            int monthChoosen = Integer.valueOf(month.getSelectedItem().toString());
            int yearChoosen = Integer.valueOf(year.getSelectedItem().toString());

            Date dob = new Date(yearChoosen, monthChoosen, dayChoosen);

            String postcodeChoosen = postcode.getText();
            String phone = phoneNumber.getText();

            if(postcodeChoosen.matches("^[A-Z]{1,2}[0-9R][0-9A-Z]? [0-9][ABD-HJLNP-UW-Z]{2}$")){
                Patient patient = new Patient(fName, sName, phone, dob, addressInputted, postcodeChoosen,
                        titleChoosen);

                Distance.insertPatient(patient);
            ...
            JOptionPane.showMessageDialog(cards, "not all values entered");
        }
    }
    ...
    private void backToMainMenuActionPerformed(ActionEvent e) {
        // TODO add your code here
    }

    private void serviceSelctorActionPerformed(ActionEvent e) {
        // TODO add your code here
    }

    private void swapToAddServiceActionPerformed(ActionEvent e) {
        // TODO add your code here
    }

    private void swapToSearchServicesActionPerformed(ActionEvent e) {
        // TODO add your code here
    }
    ...
    private void initComponents() {
        ...
        button3 = new JButton();
        Services = new JPanel();
        serviceSelctor = new JComboBox<>();
        textField6 = new JTextField();
        searchButton = new JButton();
        radioButton2 = new JRadioButton();
        radioButton3 = new JRadioButton();
        radioButton1 = new JRadioButton();
        tableServices = new JPanel();
        ...
        //======== cards ========
        {
			...
			swapToAddPatientActionPerformed(e);
                ...
                swapToAddService.addActionListener(e -> swapToAddServiceActionPerformed(e));
                ...
                swapToSearchServices.addActionListener(e -> swapToSearchServicesActionPerformed(e));
            ...
            //======== Searchservices ========
            {
                ...
                //---- service ----
                service.setModel(new DefaultComboBoxModel<>(new String[] {
                    "GP",
                    "School",
                    "Dentists"
                }));
                Searchservices.add(service, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));
                ...
                Searchservices.add(button1, new GridBagConstraints(4, 3, 2, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));

                //---- radioButton4 ----
                radioButton4.setText("nhs");
                Searchservices.add(radioButton4, new GridBagConstraints(6, 3, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));

                //---- radioButton5 ----
                radioButton5.setText("non nhs");
                Searchservices.add(radioButton5, new GridBagConstraints(7, 3, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));

                //---- radioButton6 ----
                radioButton6.setText("both");
                Searchservices.add(radioButton6, new GridBagConstraints(8, 3, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));

                //======== services ========
                {
                    services.setLayout(new CardLayout());

                    //======== scrollPane5 ========
                    {

                        //---- GP ----
                        GP.setRowSelectionAllowed(false);
                        GP.setModel(new DefaultTableModel(
                            new Object[][] {
                        ...
                        scrollPane5.setViewportView(GP);
                    }
                    services.add(scrollPane5, "card1");

                    //======== scrollPane6 ========
                    {

                        //---- School ----
                        School.setRowSelectionAllowed(false);
                        School.setModel(new DefaultTableModel(
                            new Object[][] {
                                {"test 1", "wdad,adwd, road", "LL16 5ar", "0910328314", "9-5", null, null, null},
                                {null, null, null, null, null, null, null, null},
                                {null, null, null, null, null, null, null, null},
                        ...
                        scrollPane6.setViewportView(School);
                    }
                    services.add(scrollPane6, "card2");

                    //======== scrollPane7 ========
                    {

                        //---- Dentist ----
                        Dentist.setRowSelectionAllowed(false);
                        Dentist.setModel(new DefaultTableModel(
                            new Object[][] {
                                {"test 1", "wdad,adwd, road", "LL16 5ar", "0910328314", "9-5", null, null, null},
                                {null, null, null, null, null, null, null, null},
                                {null, null, null, null, null, null, null, null},
                        ...
                        scrollPane7.setViewportView(Dentist);
                    }
                    services.add(scrollPane7, "card3");

                    //======== scrollPane8 ========
                    {

                        //---- optiains ----
                        optiains.setRowSelectionAllowed(false);
                        optiains.setModel(new DefaultTableModel(
                            new Object[][] {
                                {"test 1", "wdad,adwd, road", "LL16 5ar", "0910328314", "9-5", null, null, null},
                                {null, null, null, null, null, null, null, null},
                                {null, null, null, null, null, null, null, null},
                        ...
                        scrollPane8.setViewportView(optiains);
                    }
                    services.add(scrollPane8, "card4");
                }
                Searchservices.add(services, new GridBagConstraints(0, 4, 9, 4, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));

                //---- button3 ----
                button3.setText("back to main menu");
                Searchservices.add(button3, new GridBagConstraints(6, 8, 3, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));
            }
            ...
            //======== Services ========
            {
                ...
                //---- serviceSelctor ----
                serviceSelctor.setModel(new DefaultComboBoxModel<>(new String[] {
                    "GP",
                    "School",
                    "Dentists"
                }));
                Services.add(serviceSelctor, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));
                ...
                Services.add(searchButton, new GridBagConstraints(4, 3, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 5), 0, 0));
                ...
                //======== tableServices ========
                {
                    tableServices.setLayout(new CardLayout());
                    ...
                    tableServices.add(scrollPane1, "card1");
                    ...
                    tableServices.add(scrollPane2, "card2");
                    ...
                    tableServices.add(scrollPane3, "card3");
                    ...
                    tableServices.add(scrollPane4, "card4");
                }
                Services.add(tableServices, new GridBagConstraints(0, 4, 8, 4, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 0), 0, 0));

                //---- backToMainMenu ----
                backToMainMenu.setText("back to main menu");
                backToMainMenu.addActionListener(e -> backToMainMenuActionPerformed(e));
                Services.add(backToMainMenu, new GridBagConstraints(5, 8, 3, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 5, 0), 0, 0));
            }
        ...
        //---- nhsOrNot ----
        ButtonGroup nhsOrNot = new ButtonGroup();
        nhsOrNot.add(radioButton2);
        nhsOrNot.add(radioButton3);
        nhsOrNot.add(radioButton1);
        nhsOrNot.add(radioButton7);
        nhsOrNot.add(radioButton8);
        nhsOrNot.add(radioButton9);
    ...
    private JComboBox<String> service;
    ...
    private JTable School;
    private JScrollPane scrollPane7;
    private JTable Dentist;
    private JScrollPane scrollPane8;
    private JTable optiains;
    private JButton button3;
    private JPanel Services;
    private JComboBox<String> serviceSelctor;
    private JTextField textField6;
    private JButton searchButton;
    private JRadioButton radioButton2;
    private JRadioButton radioButton3;
    private JRadioButton radioButton1;
    private JPanel tableServices;
